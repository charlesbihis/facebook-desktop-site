...
package com.vimeo {
	...
	public class VimeoPlayer extends Sprite {
		...
		public function VimeoPlayer(oauth_key:String, clip_id:int, w:int, h:int, fp_version:int = 10) {
			...
			var request:URLRequest = new URLRequest("http://api.vimeo.com/moogaloop_api.swf?oauth_key=" + oauth_key + "&clip_id=" + clip_id + "&width=" + w + "&height=" + h + "&fullscreen=0&autoplay=1&fp_version=" + fp_version);
